package be.krivi.plutus.android.database;
...
import be.krivi.plutus.android.models.Location;
import be.krivi.plutus.android.models.Transaction;
    ...
    static class DBHelper extends SQLiteOpenHelper{
        ...
        public void onCreate( SQLiteDatabase db ){
            ...
            try{
                ...
                Message.message( context, "Something went wrong in onCreate!" );
            }
        ...
        public void onUpgrade( SQLiteDatabase db, int i, int i1 ){
            ...
            try{
                ...
                Message.message( context, "Something went wrong mate in onUpgrade!" );
            }
        }
    }
}
